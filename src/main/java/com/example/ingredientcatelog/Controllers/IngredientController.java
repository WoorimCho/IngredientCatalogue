...
import com.example.ingredientcatelog.Dto.TagNamesRequest;
import com.example.ingredientcatelog.Services.IngredientService;
...
public class IngredientController {
    ...
    public Page<IngredientResponse> list(
        ...
        return ingredientService.search(tags, match, pageable);
    }
     ...
     * recipe from RecipeCatelog). Unknown ids are omitted from the result.
